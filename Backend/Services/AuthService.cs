...
public class AuthService : IAuthService
{
    ...
    public async Task<ApiResponse<object>> RegisterAsync(RegisterDto dto)
    {
        ...
        {
            return ApiResponse<object>.Fail("EMAIL_EXISTS", "Email da ton tai.");
        }
    ...
    public async Task<ApiResponse<object>> RefreshAsync(RefreshTokenDto dto)
    {
        ...
        {
            return ApiResponse<object>.Fail("INVALID_REFRESH_TOKEN", "Refresh token khong hop le.");
        }
        ...
        if (existing.IsRevoked)
        {
            ...
            return ApiResponse<object>.Fail("TOKEN_COMPROMISED", "Phat hien truy cap bat thuong. Vui long dang nhap lai.");
        }

        if (existing.ExpiresAt <= DateTime.UtcNow)
        {
            return ApiResponse<object>.Fail("TOKEN_EXPIRED", "Phien dang nhap da het han.");
        }
    ...
    public async Task<ApiResponse<object>> LogoutAsync(LogoutDto dto, string? authHeader)
    {
    ...
    public async Task<ApiResponse<object>> GoogleLoginAsync(GoogleLoginDto dto)
    {
        ...
        {
            return ApiResponse<object>.Fail("ACCOUNT_LOCKED", "Tài khoản đã bị khóa.");
        }
    ...
    public async Task<ApiResponse<object>> ChangePasswordAsync(ChangePasswordDto dto, Guid userId)
    {
        if (dto.CurrentPassword == dto.NewPassword)
        {
            return ApiResponse<object>.Fail("SAME_PASSWORD", "Mat khau moi khong duoc giong mat khau hien tai.");
        }
        ...
        {
            return ApiResponse<object>.Fail("INVALID_PASSWORD", "Mat khau hien tai khong dung.");
        }
        ...
        return ApiResponse<object>.Ok(new { }, "Doi mat khau thanh cong. Vui long dang nhap lai.");
    }
